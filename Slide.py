...
class Slide:
	def __init__(self,root, content,contentFont=35,title=None,titleFont=55,whatTime=None,time=2,howLong=5,frame=None,paddingCtop=10,fg=foreground,bg=background,image=None):
		if frame !=None:
			self.frame = frame
		else:
